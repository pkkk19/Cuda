...
void main(int argc, char *argv[])
{
    ...
    if (threadCount <= 0)
    {
        printf("please enter number of threads after file name");
        exit(0);
    }
    ...
    if (fp1 != NULL && fp2 != NULL)
    {
        ...
        {
            printf("\nSorry, the given column of matrix A is not equal to the row of matrix B, thus matrices cannot be multiplied.\n");
        }
